        ...
        .done(function (data) {
            ...
            for (var i = 0; i < 5; i++) {
                ...
                if (i > 0) {
                    ...
                    //Replace the placeholder text in the template for data i 
...
function getBackgroundPath(iconString) {
    //Create a switch statement that switched based on the value if iconString, For each case , it should return the path to the approprate image for that iconString value, By default, it should return the path to the clear-day image
    switch (iconString) {
        case "clear-day":
        ...
        case "partly-cloudy-night":
            return "../img/party-cloudy-night.jpg";
        default:
            return "../img/clear-day.jpg";
    }
}